...
impl Display for ParseError {
    fn fmt(self: &Self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match &self.kind {
            ...
            ParseErrorKind::IllegalFunctionDef => write!(f, "Function definitions are not allowed in this position"),
            ParseErrorKind::IllegalFunctionDecl => write!(f, "Function declarations are not allowed in this position"),
            ParseErrorKind::IllegalReturn => write!(f, "Return-statements are not allowed outside of functions"),
            ParseErrorKind::IllegalYield => write!(f, "Yield-statements are not allowed outside of functions"),
            ...
            ParseErrorKind::IllegalSuspend => write!(f, "Suspend-statements are not allowed outside of functions"),
