...
use crate::prelude::*;
use crate::{StackAddress, ItemIndex, HeapAddress, FrameAddress};
...
impl<T, U> VM<T, U> {
    ...
    pub(crate) fn opcode_gen_new(&mut self, arg_size: FrameAddress, entry_map: StackAddress) {
    ...
    pub(crate) fn opcode_gen_next(&mut self) {
    ...
    pub(crate) fn opcode_gen_yield(&mut self, live_ref_map: StackAddress, value_ctor: StackAddress, value_size: FrameAddress) {
    ...
    pub(crate) fn opcode_gen_yield_kv(&mut self, live_ref_map: StackAddress, key_ctor: StackAddress, value_ctor: StackAddress, key_size: FrameAddress, value_size: FrameAddress) {
    ...
    pub(crate) fn opcode_gen_return(&mut self, value_ctor: StackAddress, key_ctor: StackAddress) {
    ...
    pub(crate) fn opcode_gen_value(&mut self, value_size: FrameAddress) {
        let value_size = value_size as usize;
        let gen_ref: HeapRef = self.stack.pop();
    ...
    pub(crate) fn opcode_gen_key(&mut self, key_size: FrameAddress) {
        let key_size = key_size as usize;
        let gen_ref: HeapRef = self.stack.pop();
