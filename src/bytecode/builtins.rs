...
/// Identifies a built-in map method.
///
/// Unlike the array/scalar/string builtins (generated by `impl_builtins!` and dispatched via the
/// `call_builtin` opcode), map methods are dispatched through dedicated VM opcodes (the `map_*`
/// opcodes in `opcodes.rs`). Maps are generic over two types (key and value) and some methods
/// allocate new collections, neither of which fits the single-element-type shape of `impl_builtins!`.
/// The resolver registers these as [`FunctionKind::MapBuiltin`](crate::shared::meta::FunctionKind)
/// and the compiler lowers each to its opcode.
...
/// # Generators
///
/// [Generators](crate::internals::documentation::generators) are functions that lazily produce a sequence of values with
/// the `yield` keyword, returning a [`Generator<V>`](crate::internals::documentation::Generator) that can be iterated with a `for` loop.
#[cfg(doc)]
pub mod documentation {
    ...
    /// the keys alone). See the [generators](self::generators) reference for writing generator functions
    ...
    /// [`Generator`](crate::internals::documentation::Generator) value rather than running the body.
    ...
    /// [`Generator`](crate::internals::documentation::Generator)): [`next`] advances to the following
    ...
    /// a fresh generator.
    ///
    /// [`next`]: crate::internals::documentation::Generator::next
    /// [`value`]: crate::internals::documentation::Generator::value
    /// [`key`]: crate::internals::documentation::Generator::key
    pub mod generators { }
}